...
/**
 * successor - get next successor (min node in the right subtree)
 * @node: tree to check
 ...
 *@root: node to remove
 *Return: 0 if it has no children or other value (if exists)
 */
...
/**
 * bst_remove - rmv node from BST tree
 * @root: root of tree
 * @value: node with value to rmv
 * Return: tree changed
 */
