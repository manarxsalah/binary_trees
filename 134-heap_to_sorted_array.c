...
/**
 * heap_to_sorted_array - conv Binary Max Heap to sorted arr of ints
 * @heap: ptr to root node of theheap to conv
 * @size: addrs to store size of arr
 * Return: generated arr, NULL (fail)
 */
